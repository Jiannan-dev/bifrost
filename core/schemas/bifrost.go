...
const (
	...
	BifrostContextKeyBypassSemanticCache                 BifrostContextKey = "bifrost-bypass-semantic-cache"                    // bool (trusted core/integration hint; search-capable requests use it to avoid replaying stale tool answers)
